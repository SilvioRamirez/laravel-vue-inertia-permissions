        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    <vue3-datatable v-if="canViewPermission"
                        ref="datatable"
                        :rows="permissions" 
                        :columns="cols" 
                        :loading="loading"
                        ...
                        <template #actions="data">
                            <div class="inline-flex rounded-md shadow-xs" role="group">
                                <Link
                                    ...
                                    :href="route('permissions.show', data.value.id)"
                                ...
                                <Link
                                    ...
                                    :href="route('permissions.edit', data.value.id)"
                                    class="btn-group-mid"
                                >
                                ...
                                <button
                                    ...
                                    @click="deletePermission(data.value.id, data.value.name)"
                                    class="btn-group-end"
                                >
...
<script setup>
    ...
    const canEditPermission = hasPermission('permission-edit')
    ...
    const deletePermission = (id, name) => {
        Swal.fire({
            title: '¿Estás seguro de eliminar el permiso ' + name + '?',
